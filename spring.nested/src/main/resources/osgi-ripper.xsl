	...
	<xsl:template match="/">
		...
		<xsl:template match="osgi:reference">
			<!--
				...
				value="com.macys.platform.util.spring.nested.NarrowDaddy"></constructor-arg>
				</bean>
			-->
		...
		<xsl:template match="osgi:service">
			<!--
				...
				class="com.macys.platform.util.spring.nested.ExportRef">
				<constructor-arg><idref local="just-bean"/></constructor-arg>
				<constructor-arg
				value="com.macys.platform.util.spring.nested.ExtendedChild"></constructor-arg>
			...
			<xsl:element name="bean">
				...
				<xsl:element name="constructor-arg">
					<xsl:element name="bean">
						<xsl:attribute name="class">com.macys.platform.util.spring.nested.ExportRef</xsl:attribute>
